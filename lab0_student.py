...
# MAGIC %md
# MAGIC #### ** (1a) Parallelize, filter, and reduce **
...
# MAGIC #### This formula shows log loss for single point. Log loss is defined as: %[  \begin{align} \scriptsize \ell_{log}(p, y) = \begin{cases} -\log (p) & \text{if } y = 1 \\\ -\log(1-p) & \text{if } y = 0 \end{cases} \end{align} ]%
...
# MAGIC %md
# MAGIC #### ** (5a) Time to submit **

# COMMAND ----------

# MAGIC %md
# MAGIC #### You have completed the lab.  To submit the lab for grading you will need to export it from Databricks Cloud.  You can do this by clicking on the three horizontal bars located in the top left of your browser window, navigating to the file in your workspace, clicking the down arrow to the right of your file, and selecting "Export" --> "Source File".  This will export your DBC notebook as a .py file to your computer.
# MAGIC #### To upload this file to the course autograder, go to the edX website and find the page for submitting this assignment.  Click "Choose file", then navigate to and click on the downloaded .py file.  Now click the "Open" button and then the "Check" button.  Your submission will be graded shortly and will be available on the page where you submitted.  Note that when submission volumes are high, it may take as long as an hour to receive results.
